...
import ir.abyx.pastry.mvp.presenter.PresenterNotificationActivity
...
class NotificationActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view = ViewNotificationActivity(this, object : ActivityUtils {
        ...
        val presenter = PresenterNotificationActivity(view, ModelNotificationActivity())
        presenter.onCreate()
    }
}